...
import { Cumpleanos, Login, RegistroAsistencia, PerfilColaborador, VistaEvaluaciones, VistaHomeColaborador, AdmiJustificacion, JustificacionColaborador } from '../components';
