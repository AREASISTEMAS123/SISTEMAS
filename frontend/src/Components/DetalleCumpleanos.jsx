            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-4 gap-4">
                {birthdayUser && birthdayUser.length > 0 ? (
                    birthdayUser.map((user) => (
                        <div className="flex flex-col bg-white rounded-lg shadow-lg" key={user.id}>
                            <img
                            ...
                            <div className="p-4 flex flex-col justify-between flex-1">
                                <div>
                                    ...
                                    <p className="text-gray-700 text-base">{user.profile.area}</p>
                                    <p className="text-gray-700 text-base">{user.profile.department}</p>
                                </div>
                                <div className="flex items-center">
                                    <div className="text-sm">
                                        <p className="text-gray-900 leading-none">{user.profile.profile_name}</p>
                                        <p className="text-gray-600">{user.profile.shift}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
