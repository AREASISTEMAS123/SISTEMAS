...
import TablaEvaluacionesDL from './TablaEvaluacionesDL';

export const VistaEvaluacionDiagnosticoLiderazgo = () => {
		...
		<>
			<div className='space-y-4'>
				<div className="bg-cv-primary px-4 py-14 rounded-lg">
					<h2 className="text-lg text-center md:text-4xl font-semibold uppercase text-white">Diagnostico de liderazgo</h2>
				</div>
